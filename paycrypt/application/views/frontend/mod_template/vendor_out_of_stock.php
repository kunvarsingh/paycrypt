    	...
    	<table cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:normal; line-height:18px;">
            ...
            <tr>
                <td style="padding:0px 10px;">
                    ...
                    <p>Your Products <strong><?php echo $product_name;?><?php /*?>‘Yonex GR 303 Badminton Racket’<?php */?></strong> has reached the safety stock of 10 products.</p>
                    
                    <p>Please update the inventory before your discontinue from Tiger</p>
