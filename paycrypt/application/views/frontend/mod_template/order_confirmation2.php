            	...
            	<td colspan="2">
                	<table cellpadding="0" cellspacing="0" style="width:100%; text-align:left; padding:5px 10px;">
					  ...
					  <tr>
						...
						<td style="border-bottom:dashed 1px #ccc;"><?php echo $order_mail_datarecord[$i]['fld_membership_plan_name'];?></td>                        
						<td style="border-bottom:dashed 1px #ccc;"><?php echo $order_mail_datarecord[$i]['fld_customer_book_start_date'];?></td>
                        <td style="border-bottom:dashed 1px #ccc;"><?php echo $order_mail_datarecord[$i]['fld_customer_book_end_date'];?></td>
                        <td style="border-bottom:dashed 1px #ccc;"><?php echo number_format($order_mail_datarecord[$i]['fld_membership_plan_price'],2);?></td>
						<?php $grand_total+=$order_mail_datarecord[$i]['fld_membership_plan_price'] ;?>
