    	...
    	<table cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:normal; line-height:18px;">
            ...
            <tr>
            	<td colspan="2" style="border-bottom:solid 1px #999; padding:0px 10px;">
                	<p>To Tiger5,</p>
                    <p>I am sending you booking of these grounds.</p>
            ...
            <tr>
                <td colspan="2" style="border-bottom:solid 1px #999; border-right:solid 1px #999; padding:0px 10px; width:50%;">
                	<p><strong>Billing Info</strong><br />
                        <?php echo $billing_address['fld_customer_name'];?><br />
                        <?php //echo $billing_address['fld_customer_address'];?>
                        <?php //echo $billing_address['fld_city_name'].','.$state;?>
            	...
            	<td colspan="2">
                	<table cellpadding="0" cellspacing="0" style="width:100%; text-align:left; padding:5px 10px;">
					  ...
					  <tr>
                        ...
                        <td style="border-bottom:dashed 1px #ccc;"><?php echo $this->MRcat->getRcat($order_mail_datarecord[$i]['ground_type'])->row()->fld_rcat_name;?></td>
                        <td style="border-bottom:dashed 1px #ccc;">
							<?php 
                        ...
                        <td style="border-bottom:dashed 1px #ccc;"><?php echo number_format((count($ss) * $order_mail_datarecord[$i]['order_price']),2);?></td>
						<?php $grand_total+=count($ss) * $order_mail_datarecord[$i]['order_price'];?>
