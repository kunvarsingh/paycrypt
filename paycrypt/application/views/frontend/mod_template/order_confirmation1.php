            	...
            	<td colspan="2">
                	<table cellpadding="0" cellspacing="0" style="width:100%; text-align:left; padding:5px 10px;">
					  ...
					  <tr>
						...
						<td style="border-bottom:dashed 1px #ccc;"><?php echo $order_mail_datarecord[$i]['fld_customer_start_date'];?></td>
                        <td style="border-bottom:dashed 1px #ccc;"><?php echo $order_mail_datarecord[$i]['fld_customer_end_date'];?></td>
