...
class Product_model extends CI_Model 
{
	...
	{
		return $this->db->get('crypto_products')->result();
	...
	public function listing_email($value)
	{
		$sql="select * from crypto_products where email='$value'";
        return $this->db->query($sql)->result();
	}
	public function description_details($label,$order)
	{
		$option = array('order_id' => $order, 'productTitle'=>$label,);
