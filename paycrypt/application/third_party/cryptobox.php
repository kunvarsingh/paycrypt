 ...
 *  1. function display_cryptobox(..)			
 // Show Cryptocoin Payment Box and automatically displays successful payment message. If $submit_btn = true, display user submit button 'Click Here if you have already sent coins' or not
 *  2. function cryptobox_json_url()           
  // It generates url with your paramenters to gourl.io payment gateway. Using this url you can get bitcoin/altcoin payment box values in JSON format and use it on html page with Jquery/Ajax.
...
class Cryptobox {
	...
	private $boxID			= 0; 		// 16409 cryptobox id, the same as on gourl.io member page. For each your cryptocoin payment boxes you will have unique public / private keys 
	...
	*/
	 ...
	 * For example, after you have successfully rxxxxcdseceived the cryptocoin payment and had processed it, you can call
...
// end class
	...
	*/
	...
	function get_country_name($countryID, $reverse = false)
	{
		...
		if ($reverse) 
			$result = array_search(ucwords(mb_strtolower($countryID)), $arr);
		elseif (isset($arr[strtoupper($countryID)])) 
